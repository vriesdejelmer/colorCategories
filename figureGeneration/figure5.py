...
##### package loading and wd setting
...
for border, sd_border in zip(median_borders, standard_dev_borders):
    plt.errorbar(border*100, 0.2+0.05*sign, xerr=sd_border*100, color='blue', linewidth=3, fmt='o', capsize=10, capthick=3, ecolor='k')
    sign = -sign
...
plt.savefig('../data/figures/manuscript/' + 'figure5.png')